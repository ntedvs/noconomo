...
const ITEMS: Item[] = [
  {
    ...
    image: "https://rlv.zcache.com/mug-r87ca0b6b68dd4b62889de22446d30246_x7jg9_8byvr_512.webp",
  },
  {
    name: "Pint Glass",
    url: "https://www.zazzle.com/pint_glass-256700030374582328",
    image: "https://rlv.zcache.com/pint_glass-r936db85f33464e479b8301f0b04add90_b1a5y_512.webp",
  },
  {
  ...
  },
  {
    ...
    image: "https://rlv.zcache.com/tote_bag-r608fbab4f46c4bcdad9236cde5a8eae2_texyj_8byvr_512.webp",
  },
  {
    name: "T-Shirt",
    url: "https://www.zazzle.com/t_shirt-235714041502017166",
    image: "https://rlv.zcache.com/t_shirt-ra5a6a00dea534254a18e18b778a161e1_k2gr0_512.webp",
  },
  {
  ...
  },
  {
    ...
    image: "https://rlv.zcache.com/kids_t_shirt-rbf3b055ce9bc4448aa03f29acf058e94_65ldk_512.webp",
  },
  {
    name: "Kids Hoodie",
    url: "https://www.zazzle.com/kids_hoodie-235528965984002537",
    image: "https://rlv.zcache.com/kids_hoodie-rcfd6cbdb1bcc46a5874719c017b4fd78_65prm_512.webp",
  },
  {
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        {ITEMS.map((item) => (
          <a
            ...
            className="border rounded p-3 flex flex-col gap-2 hover:shadow-sm"
          >
            <img
              src={item.image}
              alt={item.name}
              className="aspect-square object-contain bg-white rounded"
              loading="lazy"
            />
